...
import { Users, GitBranch, Star, TrendingUp, Lightbulb, CheckCircle, Rocket, Target, Zap } from "lucide-react"
...
export default function RoadmapPage() {
  ...
  const milestones = [
    ...
    },
    {
      ...
      description: "KubeRocketAI becomes native part of KubeRocketCI platform - second major pilot adoption",
    ...
    },
    {
      ...
      description: "KubeRocketCI platform enhanced with full AI features and enterprise-grade capabilities",
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {successMetrics.map((metric, index) => (
              <Card key={index} className="bg-black/50 border border-cyan-500/30 hover:border-cyan-400/60 transition-all duration-300">
                <CardContent className="p-6 text-center">
                  ...
                  <Badge
                    className={`mt-3 ${metric.status === 'achieved'
