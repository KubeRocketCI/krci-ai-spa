      ...
      <div className="container mx-auto px-4 pb-16 max-w-4xl">
        ...
        <div className="space-y-6 text-sm leading-relaxed">
          ...
          <section>
            ...
            <ThemedInfoBox
              variant="critical"
              title="CRITICAL: OPEN SOURCE PROJECT DISCLAIMERS"
              className="mb-4"
            >
            ...
            <ThemedInfoBox variant="critical" title="PRODUCTION USE WARNING">
          ...
          <section>
            ...
            <ThemedInfoBox variant="info" title="Ukrainian Jurisdiction Notes:" className="mb-4">
          ...
          <section>
            <ThemedHeading level={3} variant="card" className="mb-4">
              9. Risk Assessment for Users
            </ThemedHeading>

            <div className="grid md:grid-cols-3 gap-4 mb-6">
              <ThemedCard variant="stats" className="p-4">
