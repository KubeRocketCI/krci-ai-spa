...
export const OrganizationSchema = () => (
  <JsonLd>
    {{
      ...
      sameAs: ['https://github.com/KubeRocketCI', 'https://github.com/KubeRocketCI/kuberocketai'],
    }}
  </JsonLd>
);
...
export const HowToSchema = () => (
  <JsonLd>
    {{
      ...
      description:
        'Complete step-by-step guide to install and set up KubeRocketAI CLI for AI-as-Code development',
      totalTime: 'PT3M',
      estimatedCost: {
        '@type': 'MonetaryAmount',
        currency: 'USD',
