        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-green-300/60 text-sm leading-relaxed">
              Pipeline-as-Code for AI Agent Management. Version-controlled, project-aware AI agents for development teams.
            </p>
          </div>
          ...
          <div className="md:col-span-1">
            ...
            <div className="space-y-2">
              <Link href="/quickstart" className="block text-green-300/80 hover:text-green-200 text-sm transition-colors">
                Quick Start
              </Link>
              <Link href="/architecture" className="block text-green-300/80 hover:text-green-200 text-sm transition-colors">
                Architecture
              </Link>
              <Link href="/roadmap" className="block text-green-300/80 hover:text-green-200 text-sm transition-colors">
                Roadmap
              </Link>
              <a
        ...
        <div className="border-t border-green-800/30 pt-8">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              <p className="text-green-300/60 text-sm">© 2025 KubeRocketCI. Open source project.</p>
            </div>
